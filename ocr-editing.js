...
//       .extract({ left: Math.round(box.left), top: Math.round(box.top), width: Math.round(box.width), height: Math.round(box.height) })
...
//   await sharp(outputBuffer).toFile(path.join(outputPath, output_with_flipped_text_${imageName}));
// };
...
// // Function to rotate coordinates for any angle
...
//   const [newLeftTopX, newLeftTopY] = rotatePoint(box.left, box.top);
//   const [newRightBottomX, newRightBottomY] = rotatePoint(box.left + box.width, box.top + box.height);

//   return {
//     top: Math.min(newLeftTopY, newRightBottomY),
//     left: Math.min(newLeftTopX, newRightBottomX),
//     width: Math.abs(newRightBottomX - newLeftTopX),
//     height: Math.abs(newRightBottomY - newLeftTopY),
//     text: box.text
//   };
// };
...
// const directoryPath = './OCR Test/New';
// const outputPath = './OCR Output/New';
