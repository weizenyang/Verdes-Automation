...
async function rotateEquirectangularImage(inputPath, outputPath, roll, pitch, yaw) {
    try {
      ...
      console.log(`Equirec. image rotated ${degrees} degrees, saved ${path.basename(outputPath)}`);
    } catch (error) {
...
// // Example usage
rotateEquirectangularImage('360 test.jpg', '360 test - rotated reverse.jpg', 0, 0, 90)
