...
if (isMainThread) {
  ...
  (async () => {
    try {
      ...
      baseImage.filter(e => !e.name.toLowerCase().includes("ds_store")).forEach((e) => {
        // console.log(e)
      ...
      balconyImage.filter(e => !e.name.toLowerCase().includes("ds_store")).forEach((e) => {
        if(!e.name.toLowerCase().includes('ss')){
      ...
      DIM.filter(e => !e.name.toLowerCase().includes("ds_store")).forEach((e) => {
        if(!e.name.toLowerCase().includes('ss')){
      ...
      DIMFlipped.filter(e => !e.name.toLowerCase().includes("ds_store")).forEach((e) => {
        if(!e.name.toLowerCase().includes('ss')){
