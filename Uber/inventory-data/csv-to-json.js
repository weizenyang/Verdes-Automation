...
const inputCsvFile = "Aldar Uber - Merged.csv"; // Change to your actual CSV file
    ...
    fs.createReadStream(inputFile)
        ...
        .on("data", (row) => {
            results.push({
                ...
                flip: row["Mirrored"].toLowerCase() === "mirrored" ? "true" : "false",
                rotation: isNaN(parseInt(row["Unnamed: 4"])) ? 0 : parseInt(row["Unnamed: 4"]),
            });
        })
        .on("end", () => {
