...
const processDirectory = async (directoryPath, outputPath, customSVGDir) => {
  ...
  fs.readdir(directoryPath, (err, files) => {
    ...
    files.forEach(file => {
      ...
      if (path.extname(file).toLowerCase() === '.png' || path.extname(file).toLowerCase() === '.jpg' || path.extname(file).toLowerCase() === '.jpeg'|| path.extname(file).toLowerCase() === '.webp') {
...
const SVGDirectoryPath = './images/mask';
const directoryPath = './images/original';
